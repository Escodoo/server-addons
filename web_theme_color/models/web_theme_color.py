...
# 16.0 only handles the light theme: web.dark_mode_variables cannot be resolved
# on Community, its own `before` directive targets a file the bundle does not
# carry, so touching it raises. Dark mode is an Enterprise feature anyway.
THEME_ASSETS = (
    (
        PARAM_PRIMARY,
        DEFAULT_PRIMARY,
